...
import { PUBLIC_EVIDENCE_SOURCES } from "../config/public-evidence";
...
export const defaultPublicEvidenceSources: PublicEvidenceSourceConfig[] = PUBLIC_EVIDENCE_SOURCES;
